    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_update', models.DateTimeField(default=datetime.datetime(2021, 4, 6, 6, 47, 56, 796302, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ManyToManyField(blank=True, null=True, related_name='myTags', through='blog.Post_Tag', to='blog.Post')),
            ],
            options={
                'verbose_name': 'برچسب',
